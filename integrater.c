...
void MD_Propagetor_NH_Single_set_MP1996(int nc,double dt,double *dt2,
					double wdt2[3],double wdt4[3]) {
  int i,j;
...
void MD_Propagetor_NH_Single_part_MP1996(double *vel,double *mass,
...
double MD_Propagetor_NH_MP1998_AAFF_Amber(double *crd,double *vel,double *mass,
  ...
  frc=(double *)emalloc(sizeof(double)*numatom*3);
...
double MD_Propagetor_vV_NVE_AAFF_Amber(double *crd,double *vel,double *mass,
  ...
  frc=(double *)emalloc(sizeof(double)*numatom*3);
  frc_new=(double *)emalloc(sizeof(double)*numatom*3);
